...
export function buildInvitationCopy(input?: InvitationCopyInput): InvitationCopy {
  ...
  return {
    ...
    kinshipPronoun,
    dressCodeLine: `Để cùng tạo nên những khung hình đẹp và hài hòa cho đêm tiệc, ${sentenceCase(kinshipPronoun)} có thể tham khảo các ý tưởng phối đồ dựa trên bảng màu dưới đây:\n\nLưu ý thời tiết: Đà Lạt vào đông rất lạnh, ${kinshipPronoun} hãy ưu tiên trang phục và phụ kiện đủ ấm cho bữa tiệc ngoài trời nhé!`,
  };
}
