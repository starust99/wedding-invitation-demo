...
const defaultWeddingCalendarEvents: Record<WeddingCalendarEventId, WeddingCalendarEvent> = {
  ...
  album: {
    ...
    startUtc: "20270131T170000Z",
    endUtc: "20270131T173000Z",
    timeLabel: "00:00 ngày 01/02/2027",
    ...
    uid: "album-20270201@nhatphuong.love",
  },
};
...
function createAlbumCalendarTime(value: string) {
  ...
  const safeStart = Number.isNaN(start.getTime()) ? new Date("2027-02-01T00:00:00+07:00") : start;
