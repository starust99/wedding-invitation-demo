      ...
      >
        ...
        <div className="relative w-full flex flex-row justify-between items-stretch z-10 mt-4 sm:mt-5 mb-8 md:mb-10">
          ...
          <motion.div variants={familyItemVariant} className="w-1/2 pr-1 sm:pr-4 flex flex-col items-center justify-start text-center">
            ...
            <div className="flex flex-col gap-2.5 md:gap-3 text-[#3f4642]/90 font-serif text-[0.95rem] sm:text-[1rem] md:text-[1.05rem] lg:text-[1.12rem] w-full mt-1.5">
              <p className="leading-relaxed">
                <span className="text-[#7d7065] font-serif font-bold text-[0.69rem] [@media(min-width:375px)]:text-[0.73rem] [@media(min-width:390px)]:text-[0.79rem] [@media(min-width:412px)]:text-[0.82rem] sm:text-[1.17rem] md:text-[1.21rem] tracking-wider uppercase block mb-0.5 md:mb-1">Ông</span>
                <span className="font-semibold block text-[0.68rem] [@media(min-width:375px)]:text-[0.72rem] [@media(min-width:390px)]:text-[0.79rem] [@media(min-width:412px)]:text-[0.83rem] sm:text-[1.41rem] md:text-[1.49rem] lg:text-[1.59rem] tracking-[-0.015em] sm:tracking-normal whitespace-nowrap uppercase">TRẦN TRỌNG SƠN</span>
              </p>
              <p className="leading-relaxed">
                <span className="text-[#7d7065] font-serif font-bold text-[0.69rem] [@media(min-width:375px)]:text-[0.73rem] [@media(min-width:390px)]:text-[0.79rem] [@media(min-width:412px)]:text-[0.82rem] sm:text-[1.17rem] md:text-[1.21rem] tracking-wider uppercase block mb-0.5 md:mb-1">Bà</span>
                <span className="font-semibold block text-[0.68rem] [@media(min-width:375px)]:text-[0.72rem] [@media(min-width:390px)]:text-[0.79rem] [@media(min-width:412px)]:text-[0.83rem] sm:text-[1.41rem] md:text-[1.49rem] lg:text-[1.59rem] tracking-[-0.015em] sm:tracking-normal whitespace-nowrap uppercase">NGUYỄN THỊ MINH DUYÊN</span>
              </p>
            </div>
          </motion.div>
          ...
          <motion.div variants={familyItemVariant} className="w-1/2 pl-1 sm:pl-4 flex flex-col items-center justify-start text-center">
            ...
            <div className="flex flex-col gap-2.5 md:gap-3 text-[#3f4642]/90 font-serif text-[0.95rem] sm:text-[1rem] md:text-[1.05rem] lg:text-[1.12rem] w-full mt-1.5">
              <p className="leading-relaxed">
                <span className="text-[#7d7065] font-serif font-bold text-[0.69rem] [@media(min-width:375px)]:text-[0.73rem] [@media(min-width:390px)]:text-[0.79rem] [@media(min-width:412px)]:text-[0.82rem] sm:text-[1.17rem] md:text-[1.21rem] tracking-wider uppercase block mb-0.5 md:mb-1">Ông Felicite</span>
                <span className="font-semibold block text-[0.68rem] [@media(min-width:375px)]:text-[0.72rem] [@media(min-width:390px)]:text-[0.79rem] [@media(min-width:412px)]:text-[0.83rem] sm:text-[1.41rem] md:text-[1.49rem] lg:text-[1.59rem] tracking-[-0.015em] sm:tracking-normal whitespace-nowrap uppercase">NGUYỄN ĐỨC TÀI</span>
              </p>
              <p className="leading-relaxed">
                <span className="text-[#7d7065] font-serif font-bold text-[0.69rem] [@media(min-width:375px)]:text-[0.73rem] [@media(min-width:390px)]:text-[0.79rem] [@media(min-width:412px)]:text-[0.82rem] sm:text-[1.17rem] md:text-[1.21rem] tracking-wider uppercase block mb-0.5 md:mb-1">Bà Teresa</span>
                <span className="font-semibold block text-[0.68rem] [@media(min-width:375px)]:text-[0.72rem] [@media(min-width:390px)]:text-[0.79rem] [@media(min-width:412px)]:text-[0.83rem] sm:text-[1.41rem] md:text-[1.49rem] lg:text-[1.59rem] tracking-[-0.015em] sm:tracking-normal whitespace-nowrap uppercase">PHAN THỊ THU HIỀN</span>
              </p>
            </div>
          </motion.div>
        </div>
