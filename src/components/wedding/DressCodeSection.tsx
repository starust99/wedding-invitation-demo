...
export function DressCodeSection({
  ...
  return (
    <div className="w-full flex flex-col gap-6 items-center relative">
      ...
      <div className="w-full max-w-[24rem] sm:max-w-[26rem] md:max-w-[27rem] mx-auto p-3 sm:p-4 rounded-[2.2rem] bg-white/20 shadow-[0_6px_24px_rgba(63,70,66,0.02)] backdrop-blur-[6px] flex flex-col items-center">
