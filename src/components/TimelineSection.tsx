          ...
          <ol className="event-details-timeline-list timeline-garden-list relative z-10 grid w-full gap-4 sm:gap-5 px-1">
            {config.timeline.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className="timeline-garden-card !py-3 !pl-4 !pr-14 !gap-1 shadow-[0_6px_16px_rgba(63,70,66,0.07)] text-left flex flex-col items-start justify-center bg-[#fdfbf7]/95 border border-[#b4975a]/25 backdrop-blur-[8px] rounded-2xl relative overflow-hidden w-full min-w-[11rem]">
